...
contract Transactions {
    ...
    constructor(address _creator, address _supplychainAddress) public {
        Creator = _creator;
    ...
    function getUserInfo(address _address) public view returns (Supplychain.userData memory) {
        return supplychain.getUserInfo(_address);
    }
