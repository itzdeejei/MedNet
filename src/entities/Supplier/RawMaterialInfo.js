  ...
  async function getRawMaterialData() {
    ...
    let display = (
      <div>
        ...
        <a href={`data:text/plain;charset=utf-8,${encodeURIComponent(rawMaterialAddress)}`} download="rawMaterialAddress.txt">
        ...
        <p>
          ...
          <Link
            to={{
              ...
              query: { address: data[6], account: account, web3: web3, supplyChain: supplyChain },
            }}
          >
            {data[6]}
          </Link>
